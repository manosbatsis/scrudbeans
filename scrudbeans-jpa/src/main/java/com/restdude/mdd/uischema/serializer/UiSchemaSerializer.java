 ...
 */
package com.restdude.mdd.uischema.serializer;
				...
				for (Field tmpField : tmpClass.getDeclaredFields()) {
					...
					if (candidateName.equals(fieldName)) {
						...
						if (field.isAnnotationPresent(FormSchemas.class)) {
							...
							com.restdude.mdd.uischema.annotation.FormSchemaEntry[] formSchemas = formSchemasAnnotation.value();
							...
							if (formSchemas != null) {
								for (int i = 0; i < formSchemas.length; i++) {
									...
									com.restdude.mdd.uischema.annotation.FormSchemaEntry formSchemaAnnotation = formSchemas[i];
							...
							appendFormFieldSchema(formConfig, com.restdude.mdd.uischema.annotation.FormSchemaEntry.STATE_DEFAULT, com.restdude.mdd.uischema.annotation.FormSchemaEntry.TYPE_STRING);
						}
						break;
					}
				}
