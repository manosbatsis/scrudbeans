...
/**
 * An auditable base class that provides an "Version-Property" state
...
abstract class AbstractAuditablePersistableEntity<ID>(
    @CreatedDate
...
) : AbstractPersistableEntity<ID>() {

    override fun equals(other: Any?): Boolean {
        if (other == null) return false
        if (other === this) return true
        if (!AbstractAuditablePersistableEntity::class.isInstance(other)) return false
        other as AbstractAuditablePersistableEntity<ID>
