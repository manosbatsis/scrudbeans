...
@NonNullApi
public class ScrudbeansProjectDependency extends DelegatingProjectDependency {

    @Inject
    public ScrudbeansProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
