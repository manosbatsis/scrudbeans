...
package gradle.kotlin.dsl.plugins._136185eb5883031cf9757e4428c2e625
...
/**
 * The `kover` plugin implemented by [kotlinx.kover.KoverPlugin].
 */
internal
...
/**
 * The `org.jetbrains.kotlinx.kover` plugin implemented by [kotlinx.kover.KoverPlugin].
 */
internal
...
@org.gradle.api.Generated
internal
class `SePluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `se`.
 */
internal
val `PluginDependenciesSpec`.`se`: `SePluginGroup`
    get() = `SePluginGroup`(this)


/**
 * The `se.patrikerdes` plugin group.
 */
@org.gradle.api.Generated
internal
class `SePatrikerdesPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `se.patrikerdes`.
 */
internal
val `SePluginGroup`.`patrikerdes`: `SePatrikerdesPluginGroup`
    get() = `SePatrikerdesPluginGroup`(plugins)


/**
 * The `se.patrikerdes.use-latest-versions` plugin implemented by [se.patrikerdes.UseLatestVersionsPlugin].
 */
internal
val `SePatrikerdesPluginGroup`.`use-latest-versions`: PluginDependencySpec
    get() = plugins.id("se.patrikerdes.use-latest-versions")
