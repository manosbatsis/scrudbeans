 ...
 */
public interface JsonApiModelResourceCollectionDocument<T, PK extends Serializable> extends JsonApiResourceCollectionDocument<Collection<JsonApiModelResource<T, PK>>, JsonApiModelResource<T, PK>> {
